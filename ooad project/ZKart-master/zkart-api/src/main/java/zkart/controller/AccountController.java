...
public class AccountController {
	...
	public ResponseEntity<String> updateAccount(@PathVariable("id") Integer id,@RequestBody Account account)
	{
		...
		account.setId(id);
		System.out.println("ijbijbibijbijbijb ="+account);
		Account accountDetails = accountService.getAccountById(id);
		System.out.println("----------------------- ="+accountDetails.getPin());
		System.out.println("-----------------------111 ="+account.getPin());
		if (accountDetails.getPin().equals(account.getPin())) {
