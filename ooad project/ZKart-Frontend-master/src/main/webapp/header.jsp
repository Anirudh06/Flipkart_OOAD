...
<link rel="stylesheet" href="./bootstrapFiles/jquery-ui.css">
<script src = "jquery-3.3.1.min.js"></script>
<script src = "./bootstrapFiles/jquery-ui.js"></script>
...
<script type="text/javascript">
	...
	function resetPassword() {
		  ...
		  var zkartUser = JSON.stringify({"email":email});
		  $.ajax({
		    type : 'POST',
		    async: false,
		    contentType : 'application/json',
		    url : ctxPath + "/users/resetPassword",
		    dataType : "json", // data type of response
		    data : zkartUser,
		    success : function(data) {
		      if(data)
		        swal("Sent Email to you.");
		    }
		  });
		}
</script>
	<header class="header-style-1">
		...
		<div class="modal" id="loginModal" role="dialog" align="center">
			...
			<div class="floating-div"
							style="padding-left: 0px; padding-top: 15px; padding-bottom: 15px; text-align: left">
							<span class='blocking-span'> <input type="date"
								id="dob_txt" name="dob_txt" class="inputText" required />
								<span class="floating-label"><b>Enter DOB</b></span>
							</span> <span class="warning" id="warning_dob"
								style="align: left; padding-left: 0px; color: red; font-size: 80%"
								class="pull-left"> <b>Please Enter Valid DOB</b>
							</span> <span class="warning" id="warning_dob2"
								style="align: left; padding-left: 0px; color: red; font-size: 80%"
								class="pull-left"> <b>Age cannot be less than 18.</b>
							</span>
			</div>
			...
			<div class="row"
						...
						<form id="signupForm" method="post" action="#" enctype="multipart/form-data">
							<button type="button" id="signup_btn"
								...
								onclick="signup('http://localhost:8080/');">SIGN UP</button>
		...
		<div id ="old">
						...
						<div class="floating-div"
							...
							<span class='blocking-span'> <input type="password"
								...
								<a onclick="resetPassword()"> <span style="text-align: right">Forgot?</span></a>
						</div>
						...
						<div class="row"
							...
							<button type="button" id="login_btn"
								class="btn btn-primary btn-lg btn-block"
								style="border-radius: 0px; background-color: #F26419; border-width: 0mm"
								value="Login" onclick="validate('http://localhost:8080');">Login</button>
						</div>
						<div class="row"
							style="padding-left: 0px; padding-top: 15px; padding-bottom: 15px;">
							<button type="button" id=""
								class="btn btn-primary btn-lg btn-block"
								style="border-radius: 0px; box-shadow: 0 8px 16px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19); color: #2455f4; background-color: white; border-width: 0mm"
								onclick="show_signup();">New to Flipkart? Sign up</button>
						</div>
						<div class="row">
						...
						<div class="search-area">
							<form id="searchForm">
								<div class="control-group">
									<div class="row">
										<div class="col-md-10">
											<input class="search-field" id="search-bar"
												placeholder="Search for products, brands and more" />
										</div>
										<div class="col-md-2">
											<a class="search-button" id="search-button"></a>  <!-- href="underConstruct.html" -->
										</div>
									</div>
								</div>
							</form>
					...
					<ul class="horizontal">
						...
						<div class="dropdown">
								...
								<ul class="dropdown-menu" role="menu" aria-labelledby="menu1">
									...
									<li role="presentation" style="display: flex; align-items: center; width: 100%;"><a href="notifications.jsp">
									<i style="color: #157ed2" class="fas fa-bell"></i> Notifications </a></li>
									...
									<li role="presentation" style="display: flex; align-items: center; width: 100%;"><a href="index.jsp" onclick="logout()">
									<i style="color: #157ed2" class="fas fa-sign-out"></i> Logout</a></li>
								</ul>
							</div>
						</div>
						<!-- ============================================================= MY ACCOUNT END ============================================================= -->
								...
								<ul class="dropdown-menu" role="menu" aria-labelledby="menu1">
									<li role="presentation"
											...
											<a href="sellerHub.jsp"><i style="color: #157ed2"
												class="fas fa-briefcase"></i> Sell on Flipkart</a></li>
									<li role="presentation" class="divider"></li>
...
<script type="text/javascript">
	...
	function ItemAutoComplete(itemList){
		...
		for(var x in itemList){
			...
			temp['value'] = itemList[x].listingName;
			itemSearch.push(temp);
			items.push(itemList[x].listingName);
		}
	...
	$("#search-button").click(function(){
		...
		window.location.href = "http://localhost:8081/zkart-app/index2.jsp?value="+searchVal;
