...
<body >
 ...
 <hr/>
  <div align="center">
  <table><tr><td>Enter Buyer's Name</td><td>
  <input type="text" style = 'font-size:20px; text-align:center;border-style:ridge;' value="0" name="MinPrice" id="Userid" >
				...
				<div class="col-md-10">
					<div class="panel-group checkout-steps" id="accordion">
						...
						<div  id="user_panel" class="panel panel-default checkout-step-01" >
							...
							<h4>Details of list of items in wishlist</h4>
...
function fetchUsers(useid)
{
	...
	console.log(users_json);
            for(var i in users_json)
            {
            	...
            	"<td><img    class='listingImage' style='display: block; object-fit: contain; width: 50px; height: 50px;' src= "+ imgServerURL+users_json[i].item.imgUrl+"></td>"+
			            				"</tr>";
