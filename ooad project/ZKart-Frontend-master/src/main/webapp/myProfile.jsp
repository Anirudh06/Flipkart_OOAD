	       ...
	       <div id="change1" class="row">
		       ...
		       <div  class="col-md-4 sidebar" >
	            ...
	            <form id="logout_form2"><!-- action="./index.jsp" -->
		            <input type="button" class="head btn-link" style="font-size:18px ;border-color:#777 ;border-radius: 2px; color:#000;padding:5px; background-color: #ffdb4d;  "
		             value="UPDATE" onclick="changeinfo();"></input>
	            </form>
        ...
        <div class="search-result-container ">
            <div class="sidebar-widget wow fadeInUp" style="visibility: hidden; animation-name: none;">
              ...
              <div style="display: block">
                  ...
                  <p style="line-height: 1.5; margin-top: 15px;">First, you create a Flipkart Bank account. Then, using that account, you can add money to your wallet so that you can enjoy
...
function changeinfo()
{
	...
	$.ajax(
		...
		{
			swal("Updated!");
      		window.location=(ctxPath2 + "/myProfile.jsp");
			//logout();
		},
		error : function()
				{var cookieObj = $.parseJSON($.cookie('user_details')); //might be done automatically, not sure cookieObj.firstName = fname; $.cookie('user_details', JSON.stringify(cookieObj))
				logout();
					}
		});
}
function updateJSON()
{
	var userDetails = getCookie("user_details");
