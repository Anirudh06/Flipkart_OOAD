	...
	<header>
		<nav class="nav navbar-default" style="background-color:#027cd5">
			...
			<div style="float:right; padding-top:30px; padding-right: 5px">
				<span><a style="text-decoration:underline; color:white;font-size: 20px; font-weight:500;" href="adminDeals.jsp">Add Simple deals </a>	&nbsp;&nbsp;&nbsp;			</span>
				<span>
				<a style="text-decoration:underline; color:white;font-size: 20px; font-weight:500;" href="adminDeal.jsp">Add Combo deals</a></span><br/>
							...
							<div id="#collapseCategories" class="panel-collapse collapse in">
							    <div class="panel-body">
							       ...
							       <div class="container">
									...
									<button style="width:100%;" class="btn btn-primary" onclick="deleteCategory()">Delete Category</button>
									<button style="width:100%;" class="btn btn-primary" onclick="updateCategory()">Update Category</button>
									<span id="CategorySpan" ></span><br/> 
								</div>
								</div>
							</div>
							<!-- panel-body  --><!-- row -->
							...
							<div id="#collapseSubcategories" class="panel-collapse collapse in">
							    <div class="panel-body">
							       <div class="container">
									...
									<button style="width:100%;" class="btn btn-primary" onclick="deleteSubCategory()">Delete SubCategory</button>
									<button style="width:100%;" class="btn btn-primary" onclick="updateSubCategory()">Update SubCategory</button>
									<button style="width:100%;" class="btn btn-primary" onclick="addFilter()">Add Filters</button>
									<span id="subCategorySpan" ></span><br/> 
								</div>
								</div>
							</div>
							<!-- panel-body  --><!-- row -->
