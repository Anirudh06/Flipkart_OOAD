...
<head>
	...
	<title>Wishlist | ZKart.com </title>
...
<div class="body-content outer-top-xs" id="cartBody">
	...
	<div class="table-responsive">
		...
		<table class="table" id="myTable">
			<thead>
				<tr>
					<th class="cart-quantity item" colspan="7" style="text-align: left; font-size: 16px" id="cartQuant">My Wishlist</th>
				</tr>
			</thead><!-- /thead -->
			<tbody id="content">
 ...
 <div class="body-content outer-top-xs" id="emptyCart" style="text-align: center; padding: 30px 0 36px 0;">
 	...
 	<span style="display: block; font-size: 18px; margin-top: 24px;">Your Wishlist is empty</span>
 </div>
...
function getCartItems(){
	...
	$.ajax(
	{
		...
		url : ctxPath + "/wishlist/user/"+userId,
...
function renderCartItem(cartItems){
  ...
  console.log(cartItems[0]);
	...
	for(var i in cartItems){
		...
		var itemID = cartItems[i].item.id;
		...
		$.ajax(
	      ...
	      //       "</td>"+
			    ...
			    data += "<td><a style='color:black' id=href='#' onclick='deleteRow(this,"+i+")'><i class='fa fa-trash'></i></a></td>";
				data += "</tr>";
...
function deleteRow(r, i) {
  ...
  console.log(r+" "+i);
  var cid="#cartId"+i;
  var wishlistId=$(cid).val();
  console.log("value:"+wishlistId);
	swal({
		  title: "Are you sure?",
			...
			$.ajax(
					{
						type : 'DELETE',
						contentType : 'application/json',
						url : ctxPath + "/wishlist/delete/"+wishlistId,
						success : function(){
							swal("Item removed!", {
							      icon: "success",
							});
