          			...
          			<div class="card">
            			<div class="card-body p-5">
							...
							<form action="#">
								...
								<div class="form-group">
									<label>Email ID</label> <input type="email" id="email" placeholder="Enter email" disabled class="form-control" required>
								...
								<div class="form-group">
									<label>Mobile Number</label> <input type="number" disabled id="phone" class="form-control"
								...
								<div class="form-group">
									<label>Address</label>
									<textarea placeholder="Enter Address"class="form-control" rows="2" cols="50" id="Address" required> </textarea>
								</div>
								<div>
								...
								<div align="right"><button class="btn btn-primary" type="button" onclick="signup('http://localhost:8080');">Continue</button></div>
							</form>
						</div>
					</div>
				</div>
