...
function signup(ctxPath)
{
	...
	success : function(data) {console.log("Rendring details"); renderDetails(data);},
	error : function(err)
			{
...
{
	console.log("renderDetails: " + user);
	if (user == null)
	{
