...
<body>
    <header><a href="#"><img src="./images/sellerHub/seller-hub-logo.png" id="flipkartsellerhub" class="flipkartsellerhub"></a>
        <form class="form-inline bootstrap-form-with-validation" action="#">
            ...
            <input class="btn btn-default" type="button" onclick="return sellerLogin();" value="Login"/>
        </form>
    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navcol-1">
            <ul class="nav navbar-nav">
                ...
                <li role="presentation"><a href="index.jsp">ZKart.com</a></li>
            </ul>
        </div>
    </div>
 </header>
...
function sellerLogin(){
	$.ajax({
		...
		success : function(result) 
		{
			...
			if (result !== undefined) {
				if(result.email != $("#email-input").val() || result.password != $("#password-input").val())
		         {
				...
				{
	 				swal("Create different account for seller.");
	 				//window.location.reload(true);
					return false;
				}
...
{	
	...
	let x = error;
 	swal({
 	 	title : "Enter valid login credentials",
 	 	icon: "warning"
 	 	});
	return false;
}
