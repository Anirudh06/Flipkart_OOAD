						...
						<div class="navbar-collapse collapse"
							...
							<div class="nav-outer">
								<ul class="nav navbar-nav" id="category_dropdown">
									...
									<li class="active dropdown yamm-fw">
										<a	href="sellerViewOrder.jsp" style="color:black">View Active Orders</a></li>
									<li class="active dropdown yamm-fw">
										<a	href="sellerListingDeals.jsp" style="color:black">Add Normal Deal To Listing</a></li>
									<li class="active dropdown yamm-fw">
										<a	href="sellerListingDeal.jsp" style="color:black">Add Combo Deal To Listing</a></li>
									<li class="active dropdown yamm-fw">
										<a	href="sellerAddAccount.jsp" style="color:black">Add Account</a></li>
									<li class="active dropdown yamm-fw">
										<a	href="sellerViewBalance.jsp" style="color:black">View Account Balance</a></li>
